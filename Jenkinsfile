pipeline {
    agent any
    parameters{
        string(name: "SPEC", defauktValue: "cypress/e2e/**/**", description:"cypress/e2e/spec.cy.spec")
        choices(name: "BROWSER", choices:['chrome','edge','firefox'], description : "Escoja un browser"])
    }
